...
public class YoungestAndOldestAthleteOfEachYearMapper extends
		Mapper<LongWritable, Text, LongWritable, Text> {

	private static final LongWritable keyYearValue = new LongWritable();

	private static final Text playerNameValueTextWithAge = new Text();

	private static final Log log = LogFactory.getLog(YoungestAndOldestAthleteOfEachYearMapper.class);
	...
	public void map(LongWritable key, Text value, Context context)
		...
		playerNameValueTextWithAge
				.set(appendedAgeandPlayerNameValue.toString());

		context.write(keyYearValue, playerNameValueTextWithAge);
